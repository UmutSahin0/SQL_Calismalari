/* Soru 1: country tablosunda bulunan country sütunundaki ülke isimlerinden 'A' karakteri ile 
başlayıp 'a' karakteri ile sonlananları sıralayınız. */
SELECT * FROM country WHERE country LIKE 'A%a'

/* Soru 2: country tablosunda bulunan country sütunundaki ülke isimlerinden en az 6 karakterden oluşan 
ve sonu 'n' karakteri ile sonlananları sıralayınız. */
SELECT * FROM country WHERE LENGTH(country)>6 AND country LIKE '%n'

/* Soru 3: film tablosunda bulunan title sütunundaki film isimlerinden en az 4 adet büyük ya da 
...
/*Soru 4: film tablosunda bulunan tüm sütunlardaki verilerden title 'C' karakteri ile başlayan ve 
