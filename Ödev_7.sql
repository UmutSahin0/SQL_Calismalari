...
/* Soru 3: customer tablosunda bulunan store_id değerlerine karşılık gelen müşteri sayıları nelerdir? */
SELECT  store_id,COUNT(*) as count_customer FROM customer GROUP BY store_id

/* Soru 4: city tablosunda bulunan şehir verilerini country_id sütununa göre gruplandırdıktan sonra en fazla 
